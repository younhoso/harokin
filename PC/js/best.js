...
$(document).ready(function() {
	jQuery('#best01').services({										
		width:1200,          //가로사이즈(총 사이즈는 +60픽셀이 더 적용됩니다(디자인여백때문)
		height:345,		    //세로크기(지정된 사이즈값보다 총세로길이는 +40픽셀 추가됩니다.)
		slideAmount:3,      //한화면에 보일 아이템 갯수(지정된 값에 따라 이미지 및 영역이 자동으로 리사이즈를 합니다.)
